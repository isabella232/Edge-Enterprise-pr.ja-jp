...
ms.locfileid: "11325907"
---
# <span data-ttu-id="31050-103">Microsoft Edge WebView2 - ポリシー</span><span class="sxs-lookup"><span data-stu-id="31050-103">Microsoft Edge WebView2 - Policies</span></span>
...
## <span data-ttu-id="31050-108">使用可能なポリシー</span><span class="sxs-lookup"><span data-stu-id="31050-108">Available policies</span></span>
...
### [*<span data-ttu-id="31050-112">ローダーの上書き設定</span><span class="sxs-lookup"><span data-stu-id="31050-112">Loader Override Settings</span></span>*](#loader-override-settings-policies)
...
|[<span data-ttu-id="31050-117">releaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="31050-117">ReleaseChannelPreference</span></span>](#releasechannelpreference)|<span data-ttu-id="31050-118">リリースチャネルの優先検索順序を設定する</span><span class="sxs-lookup"><span data-stu-id="31050-118">Set the release channel search order preference</span></span>|
  ...
  ## <span data-ttu-id="31050-119">ローダーの上書き設定ポリシー</span><span class="sxs-lookup"><span data-stu-id="31050-119">Loader Override Settings policies</span></span>
  ...
  ### <span data-ttu-id="31050-121">browserExecutableFolder</span><span class="sxs-lookup"><span data-stu-id="31050-121">BrowserExecutableFolder</span></span>

  #### <span data-ttu-id="31050-122">ブラウザーの実行可能フォルダーの場所を構成する</span><span class="sxs-lookup"><span data-stu-id="31050-122">Configure the location of the browser executable folder</span></span>

  
  
  #### <span data-ttu-id="31050-123">サポートされているバージョン:</span><span class="sxs-lookup"><span data-stu-id="31050-123">Supported versions:</span></span>
  ...
  #### <span data-ttu-id="31050-125">説明</span><span class="sxs-lookup"><span data-stu-id="31050-125">Description</span></span>
...
<span data-ttu-id="31050-128">フォルダーパスの値を設定するには、値の名前と値のペアを入力します。</span><span class="sxs-lookup"><span data-stu-id="31050-128">To set the value for the folder path, provide a Value name and Value pair.</span></span> <span data-ttu-id="31050-129">アプリケーションユーザーモデル ID または実行可能ファイル名に値の名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="31050-129">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="31050-130">すべてのアプリケーションに適用するには、""\*" wildcardを値の名前として使用できます。</span><span class="sxs-lookup"><span data-stu-id="31050-130">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <span data-ttu-id="31050-131">サポートされている機能:</span><span class="sxs-lookup"><span data-stu-id="31050-131">Supported features:</span></span>
  ...
  #### <span data-ttu-id="31050-135">［データの種類］:</span><span class="sxs-lookup"><span data-stu-id="31050-135">Data Type:</span></span>

  - <span data-ttu-id="31050-136">文字列のリスト</span><span class="sxs-lookup"><span data-stu-id="31050-136">List of strings</span></span>

  #### <span data-ttu-id="31050-137">Windows の情報と設定</span><span class="sxs-lookup"><span data-stu-id="31050-137">Windows information and settings</span></span>

  ##### <span data-ttu-id="31050-138">グループ ポリシー (ADMX) 情報</span><span class="sxs-lookup"><span data-stu-id="31050-138">Group Policy (ADMX) info</span></span>
  ...
  ##### <span data-ttu-id="31050-144">Windows レジストリの設定</span><span class="sxs-lookup"><span data-stu-id="31050-144">Windows Registry Settings</span></span>
  ...
  ##### <span data-ttu-id="31050-149">サンプル値:</span><span class="sxs-lookup"><span data-stu-id="31050-149">Example value:</span></span>
...
```
  ...
  ### <span data-ttu-id="31050-151">releaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="31050-151">ReleaseChannelPreference</span></span>

  #### <span data-ttu-id="31050-152">リリースチャネルの優先検索順序を設定する</span><span class="sxs-lookup"><span data-stu-id="31050-152">Set the release channel search order preference</span></span>

  
  
  #### <span data-ttu-id="31050-153">サポートされているバージョン:</span><span class="sxs-lookup"><span data-stu-id="31050-153">Supported versions:</span></span>
  ...
  #### <span data-ttu-id="31050-155">説明</span><span class="sxs-lookup"><span data-stu-id="31050-155">Description</span></span>
...
<span data-ttu-id="31050-158">リリースチャネルの基本設定の値を設定するには、値の名前と値のペアを入力します。</span><span class="sxs-lookup"><span data-stu-id="31050-158">To set the value for the release channel preference, provide a Value name and Value pair.</span></span> <span data-ttu-id="31050-159">アプリケーションユーザーモデル ID または実行可能ファイル名に値の名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="31050-159">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="31050-160">すべてのアプリケーションに適用するには、""\*" wildcardを値の名前として使用できます。</span><span class="sxs-lookup"><span data-stu-id="31050-160">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <span data-ttu-id="31050-161">サポートされている機能:</span><span class="sxs-lookup"><span data-stu-id="31050-161">Supported features:</span></span>
  ...
  #### <span data-ttu-id="31050-165">［データの種類］:</span><span class="sxs-lookup"><span data-stu-id="31050-165">Data Type:</span></span>

  - <span data-ttu-id="31050-166">文字列のリスト</span><span class="sxs-lookup"><span data-stu-id="31050-166">List of strings</span></span>

  #### <span data-ttu-id="31050-167">Windows の情報と設定</span><span class="sxs-lookup"><span data-stu-id="31050-167">Windows information and settings</span></span>

  ##### <span data-ttu-id="31050-168">グループ ポリシー (ADMX) 情報</span><span class="sxs-lookup"><span data-stu-id="31050-168">Group Policy (ADMX) info</span></span>
  ...
  ##### <span data-ttu-id="31050-174">Windows レジストリの設定</span><span class="sxs-lookup"><span data-stu-id="31050-174">Windows Registry Settings</span></span>
  ...
  ##### <span data-ttu-id="31050-179">サンプル値:</span><span class="sxs-lookup"><span data-stu-id="31050-179">Example value:</span></span>
...
## <span data-ttu-id="31050-181">関連項目</span><span class="sxs-lookup"><span data-stu-id="31050-181">See also</span></span>
