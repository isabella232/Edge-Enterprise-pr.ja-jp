...
### [<span data-ttu-id="1adbf-114">アプリケーション</span><span class="sxs-lookup"><span data-stu-id="1adbf-114">Applications</span></span>](#applications-policies)
...
### [<span data-ttu-id="1adbf-151">Microsoft Edge WebView</span><span class="sxs-lookup"><span data-stu-id="1adbf-151">Microsoft Edge WebView</span></span>](#microsoft-edge-webview-policies)
...
<span data-ttu-id="1adbf-169">このポリシーは、Microsoft® Active Directory®ドメインに参加している Windows インスタンスでのみ使用できます。</span><span class="sxs-lookup"><span data-stu-id="1adbf-169">This policy is available only on Windows instances that are joined to a Microsoft® Active Directory® domain.</span></span>
...
- <span data-ttu-id="1adbf-229">パス: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span><span class="sxs-lookup"><span data-stu-id="1adbf-229">Path: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span></span>
...
- <span data-ttu-id="1adbf-266">値の名前: </span><span class="sxs-lookup"><span data-stu-id="1adbf-266">Value Name:</span></span> 
  ...
  - <span data-ttu-id="1adbf-270">(Dev): Update{0D50BFEC-CD6A-4F9A-964C-C7416E3ACB10}</span><span class="sxs-lookup"><span data-stu-id="1adbf-270">(Dev): Update{0D50BFEC-CD6A-4F9A-964C-C7416E3ACB10}</span></span>
...
#### <span data-ttu-id="1adbf-301">説明</span><span class="sxs-lookup"><span data-stu-id="1adbf-301">Description</span></span>
...
- <span data-ttu-id="1adbf-339">パス: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span><span class="sxs-lookup"><span data-stu-id="1adbf-339">Path: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span></span>
...
<span data-ttu-id="1adbf-354">このポリシーを無効にした場合、または構成しなかった場合、'[ターゲットバージョンの上書き](#targetversionprefix)' で指定されているバージョンよりも高いバージョンにするようなインストールは変化せずそのまま残ります。</span><span class="sxs-lookup"><span data-stu-id="1adbf-354">If you disable this policy or don't configure it, installs that have a version higher than that specified by '[Target version override](#targetversionprefix)' will be left as-is.</span></span>
...
- <span data-ttu-id="1adbf-370">GP パス: </span><span class="sxs-lookup"><span data-stu-id="1adbf-370">GP path:</span></span> 
  ...
  - <span data-ttu-id="1adbf-372">管理用テンプレート/Microsoft Edge Update/アプリケーション/Microsoft Edge Beta</span><span class="sxs-lookup"><span data-stu-id="1adbf-372">Administrative Templates/Microsoft Edge Update/Applications/Microsoft Edge Beta</span></span>
...
#### <span data-ttu-id="1adbf-389">説明</span><span class="sxs-lookup"><span data-stu-id="1adbf-389">Description</span></span>
...
- <span data-ttu-id="1adbf-408">キーの値: </span><span class="sxs-lookup"><span data-stu-id="1adbf-408">Value Name:</span></span> 
  - <span data-ttu-id="1adbf-409">(Stable): TargetVersionPrefix{56EB18F8-B008-4CBD-B6D2-8C97FE7E9062}</span><span class="sxs-lookup"><span data-stu-id="1adbf-409">(Stable): TargetVersionPrefix{56EB18F8-B008-4CBD-B6D2-8C97FE7E9062}</span></span>
...
- <span data-ttu-id="1adbf-429">GP パス: 管理用テンプレート/Microsoft Edge Update/基本設定</span><span class="sxs-lookup"><span data-stu-id="1adbf-429">GP path: Administrative Templates/Microsoft Edge Update/Preferences</span></span>
...
- <span data-ttu-id="1adbf-448">GP の名前: 自動更新チェックを停止する 1 日あたりの時間帯</span><span class="sxs-lookup"><span data-stu-id="1adbf-448">GP name: Time period in each day to suppress auto-update check</span></span>
  - <span data-ttu-id="1adbf-449">オプション { Hour, Minute, Duration }</span><span class="sxs-lookup"><span data-stu-id="1adbf-449">Options { Hour, Minute, Duration }</span></span>
...
#### <span data-ttu-id="1adbf-466">説明</span><span class="sxs-lookup"><span data-stu-id="1adbf-466">Description</span></span>
...
- <span data-ttu-id="1adbf-480">GP ADMX ファイル名:  msedgeupdate.admx</span><span class="sxs-lookup"><span data-stu-id="1adbf-480">GP ADMX file name: msedgeupdate.admx</span></span>
##### <span data-ttu-id="1adbf-481">Windows レジストリの設定</span><span class="sxs-lookup"><span data-stu-id="1adbf-481">Windows Registry Settings</span></span>
- <span data-ttu-id="1adbf-482">パス: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span><span class="sxs-lookup"><span data-stu-id="1adbf-482">Path: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span></span>
- <span data-ttu-id="1adbf-483">値の名前: ProxyMode</span><span class="sxs-lookup"><span data-stu-id="1adbf-483">Value Name: ProxyMode</span></span>
- <span data-ttu-id="1adbf-484">値の種類: REG_SZ</span><span class="sxs-lookup"><span data-stu-id="1adbf-484">Value Type: REG_SZ</span></span>
##### <span data-ttu-id="1adbf-485">サンプル値:</span><span class="sxs-lookup"><span data-stu-id="1adbf-485">Example value:</span></span>
```
fixed_servers
```
[<span data-ttu-id="1adbf-486">ページのトップへ</span><span class="sxs-lookup"><span data-stu-id="1adbf-486">Back to top</span></span>](#microsoft-edge---update-policies)


### <span data-ttu-id="1adbf-487">ProxyPacUrl</span><span class="sxs-lookup"><span data-stu-id="1adbf-487">ProxyPacUrl</span></span>
#### <span data-ttu-id="1adbf-488">プロキシ .pac ファイルへの URL</span><span class="sxs-lookup"><span data-stu-id="1adbf-488">URL to a proxy .pac file</span></span>
><span data-ttu-id="1adbf-489">Microsoft Edge Update 1.3.21.81 以降</span><span class="sxs-lookup"><span data-stu-id="1adbf-489">Microsoft Edge Update 1.3.21.81 and later</span></span>

#### <span data-ttu-id="1adbf-490">説明</span><span class="sxs-lookup"><span data-stu-id="1adbf-490">Description</span></span>
<span data-ttu-id="1adbf-491">プロキシ自動構成 (PAC) ファイルの URL を指定できます。</span><span class="sxs-lookup"><span data-stu-id="1adbf-491">Allows you to specify a URL for a proxy auto-config (PAC) file.</span></span>

  <span data-ttu-id="1adbf-492">このポリシーを有効にした場合、PAC ファイルの URL を指定して、特定の Web サイトを取得するための適切なプロキシサーバーを Microsoft Edge Update で選択する方法を自動化できます。</span><span class="sxs-lookup"><span data-stu-id="1adbf-492">If you enable this policy, you can specify a URL for a PAC file to automate how Microsoft Edge Update selects the appropriate proxy server for fetching a particular website.</span></span>

  <span data-ttu-id="1adbf-493">このポリシーは、 '[プロキシサーバー設定の指定方法を選択する](#proxymode)' ポリシーで手動プロキシ設定を指定した場合にのみ適用されます。</span><span class="sxs-lookup"><span data-stu-id="1adbf-493">This policy is applied only if you have specified manual proxy settings in the '[Choose how to specify proxy server settings](#proxymode)' policy.</span></span>

  <span data-ttu-id="1adbf-494">'[プロキシ サーバーの設定をどのように指定するかを選択する](#proxymode)'ポリシーで手動以外のプロキシ設定を選択した場合は、このポリシーを構成しないでください。</span><span class="sxs-lookup"><span data-stu-id="1adbf-494">Don't configure this policy if you have selected a proxy setting other than manual in the '[Choose how to specify proxy server settings](#proxymode)' policy.</span></span>
#### <span data-ttu-id="1adbf-495">Windows の情報と設定</span><span class="sxs-lookup"><span data-stu-id="1adbf-495">Windows information and settings</span></span>
##### <span data-ttu-id="1adbf-496">グループ ポリシー (ADMX) 情報</span><span class="sxs-lookup"><span data-stu-id="1adbf-496">Group Policy (ADMX) info</span></span>
- <span data-ttu-id="1adbf-497">GP 固有の名前: ProxyPacUrl</span><span class="sxs-lookup"><span data-stu-id="1adbf-497">GP unique name: ProxyPacUrl</span></span>
- <span data-ttu-id="1adbf-498">GP の名前: プロキシ .pac ファイルへの URL</span><span class="sxs-lookup"><span data-stu-id="1adbf-498">GP name: URL to a proxy .pac file</span></span>
- <span data-ttu-id="1adbf-499">GP パス: 管理用テンプレート/Microsoft Edge Update/プロキシ サーバー</span><span class="sxs-lookup"><span data-stu-id="1adbf-499">GP path: Administrative Templates/Microsoft Edge Update/Proxy Server</span></span>
- <span data-ttu-id="1adbf-500">GP ADMX ファイル名:  msedgeupdate.admx</span><span class="sxs-lookup"><span data-stu-id="1adbf-500">GP ADMX file name: msedgeupdate.admx</span></span>
##### <span data-ttu-id="1adbf-501">Windows レジストリの設定</span><span class="sxs-lookup"><span data-stu-id="1adbf-501">Windows Registry Settings</span></span>
- <span data-ttu-id="1adbf-502">パス: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span><span class="sxs-lookup"><span data-stu-id="1adbf-502">Path: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span></span>
- <span data-ttu-id="1adbf-503">値の名前: ProxyPacUrl</span><span class="sxs-lookup"><span data-stu-id="1adbf-503">Value Name: ProxyPacUrl</span></span>
- <span data-ttu-id="1adbf-504">値の種類: REG_SZ</span><span class="sxs-lookup"><span data-stu-id="1adbf-504">Value Type: REG_SZ</span></span>
##### <span data-ttu-id="1adbf-505">サンプル値:</span><span class="sxs-lookup"><span data-stu-id="1adbf-505">Example value:</span></span>
```
https://www.microsoft.com
```
[<span data-ttu-id="1adbf-506">ページのトップへ</span><span class="sxs-lookup"><span data-stu-id="1adbf-506">Back to top</span></span>](#microsoft-edge---update-policies)


### <span data-ttu-id="1adbf-507">ProxyServer</span><span class="sxs-lookup"><span data-stu-id="1adbf-507">ProxyServer</span></span>
#### <span data-ttu-id="1adbf-508">プロキシ サーバーのアドレスまたは URL</span><span class="sxs-lookup"><span data-stu-id="1adbf-508">Address or URL of proxy server</span></span>
><span data-ttu-id="1adbf-509">Microsoft Edge Update 1.3.21.81 以降</span><span class="sxs-lookup"><span data-stu-id="1adbf-509">Microsoft Edge Update 1.3.21.81 and later</span></span>

#### <span data-ttu-id="1adbf-510">説明</span><span class="sxs-lookup"><span data-stu-id="1adbf-510">Description</span></span>
<span data-ttu-id="1adbf-511">Microsoft Edge Update で使用するプロキシ サーバーの URL を指定できます。</span><span class="sxs-lookup"><span data-stu-id="1adbf-511">Allows you to specify the URL of the proxy server for Microsoft Edge Update to use.</span></span>

  <span data-ttu-id="1adbf-512">このポリシーを有効にした場合、組織内の Microsoft Edge Update が使用するプロキシ サーバーの URL を設定できます。</span><span class="sxs-lookup"><span data-stu-id="1adbf-512">If you enable this policy, you can set the proxy server URL used by Microsoft Edge Update in your organization.</span></span>

  <span data-ttu-id="1adbf-513">このポリシーは、 '[プロキシサーバー設定の指定方法を選択する](#proxymode)' ポリシーで手動プロキシ設定を指定した場合にのみ適用されます。</span><span class="sxs-lookup"><span data-stu-id="1adbf-513">This policy is applied only if you have selected manual proxy settings in the '[Choose how to specify proxy server settings](#proxymode)' policy.</span></span>

  <span data-ttu-id="1adbf-514">'[プロキシ サーバーの設定をどのように指定するかを選択する](#proxymode)'ポリシーで手動以外のプロキシ設定を選択した場合は、このポリシーを構成しないでください。</span><span class="sxs-lookup"><span data-stu-id="1adbf-514">Don't configure this policy if you have selected a proxy setting other than manual in the '[Choose how to specify proxy server settings](#proxymode)' policy.</span></span>
#### <span data-ttu-id="1adbf-515">Windows の情報と設定</span><span class="sxs-lookup"><span data-stu-id="1adbf-515">Windows information and settings</span></span>
##### <span data-ttu-id="1adbf-516">グループ ポリシー (ADMX) 情報</span><span class="sxs-lookup"><span data-stu-id="1adbf-516">Group Policy (ADMX) info</span></span>
- <span data-ttu-id="1adbf-517">GP 固有の名前: ProxyServer</span><span class="sxs-lookup"><span data-stu-id="1adbf-517">GP unique name: ProxyServer</span></span>
- <span data-ttu-id="1adbf-518">GP の名前: プロキシ サーバーのアドレスまたは URL</span><span class="sxs-lookup"><span data-stu-id="1adbf-518">GP name: Address or URL of proxy server</span></span>
- <span data-ttu-id="1adbf-519">GP パス: 管理用テンプレート/Microsoft Edge Update/プロキシ サーバー</span><span class="sxs-lookup"><span data-stu-id="1adbf-519">GP path: Administrative Templates/Microsoft Edge Update/Proxy Server</span></span>
- <span data-ttu-id="1adbf-520">GP ADMX ファイル名:  msedgeupdate.admx</span><span class="sxs-lookup"><span data-stu-id="1adbf-520">GP ADMX file name: msedgeupdate.admx</span></span>
##### <span data-ttu-id="1adbf-521">Windows レジストリの設定</span><span class="sxs-lookup"><span data-stu-id="1adbf-521">Windows Registry Settings</span></span>
- <span data-ttu-id="1adbf-522">パス: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span><span class="sxs-lookup"><span data-stu-id="1adbf-522">Path: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span></span>
- <span data-ttu-id="1adbf-523">値の名前: ProxyServer</span><span class="sxs-lookup"><span data-stu-id="1adbf-523">Value Name: ProxyServer</span></span>
- <span data-ttu-id="1adbf-524">値の種類: REG_SZ</span><span class="sxs-lookup"><span data-stu-id="1adbf-524">Value Type: REG_SZ</span></span>
##### <span data-ttu-id="1adbf-525">サンプル値:</span><span class="sxs-lookup"><span data-stu-id="1adbf-525">Example value:</span></span>
```
https://www.microsoft.com
```
[<span data-ttu-id="1adbf-526">ページのトップへ</span><span class="sxs-lookup"><span data-stu-id="1adbf-526">Back to top</span></span>](#microsoft-edge---update-policies)


## <span data-ttu-id="1adbf-527">Microsoft Edge WebView に関するポリシー</span><span class="sxs-lookup"><span data-stu-id="1adbf-527">Microsoft Edge WebView policies</span></span>

[<span data-ttu-id="1adbf-528">ページのトップへ</span><span class="sxs-lookup"><span data-stu-id="1adbf-528">Back to top</span></span>](#microsoft-edge---update-policies)
### <span data-ttu-id="1adbf-529">インストール (WebView)</span><span class="sxs-lookup"><span data-stu-id="1adbf-529">Install (WebView)</span></span>
#### <span data-ttu-id="1adbf-530">インストールを許可する</span><span class="sxs-lookup"><span data-stu-id="1adbf-530">Allow installation</span></span>
><span data-ttu-id="1adbf-531">Microsoft Edge Update 1.3.127.1 以降</span><span class="sxs-lookup"><span data-stu-id="1adbf-531">Microsoft Edge Update 1.3.127.1 and later</span></span>

#### <span data-ttu-id="1adbf-532">説明</span><span class="sxs-lookup"><span data-stu-id="1adbf-532">Description</span></span>
<span data-ttu-id="1adbf-533">Microsoft Edge Update を使用して Microsoft Edge WebView をインストールできるかどうかを指定します。</span><span class="sxs-lookup"><span data-stu-id="1adbf-533">Lets you specify whether Microsoft Edge WebView can be installed using Microsoft Edge Update.</span></span>

  - <span data-ttu-id="1adbf-534">このポリシーを有効にした場合、ユーザーは Microsoft Edge Update を使用して、Microsoft Edge WebView をインストールできます。</span><span class="sxs-lookup"><span data-stu-id="1adbf-534">If you enable this policy, users can install Microsoft Edge WebView through Microsoft Edge Update.</span></span>
  - <span data-ttu-id="1adbf-535">このポリシーを無効にした場合、ユーザーは Microsoft Edge Update を使用して Microsoft Edge WebView をインストールできません。</span><span class="sxs-lookup"><span data-stu-id="1adbf-535">If you disable this policy, users cannot install Microsoft Edge WebView through Microsoft Edge Update.</span></span>
  - <span data-ttu-id="1adbf-536">このポリシーを構成しなかった場合、"[インストールの既定の動作を許可する](#installdefault)" ポリシーの構成に従って、ユーザーが Microsoft Edge Update を使用して Microsoft Edge WebView をインストールできるかどうかが決まります。</span><span class="sxs-lookup"><span data-stu-id="1adbf-536">If you don't configure this policy, the '[Allow installation default](#installdefault)' policy configuration determines whether users can install Microsoft Edge WebView through Microsoft Edge Update.</span></span>
#### <span data-ttu-id="1adbf-537">Windows の情報と設定</span><span class="sxs-lookup"><span data-stu-id="1adbf-537">Windows information and settings</span></span>
##### <span data-ttu-id="1adbf-538">グループ ポリシー (ADMX) 情報</span><span class="sxs-lookup"><span data-stu-id="1adbf-538">Group Policy (ADMX) info</span></span>
- <span data-ttu-id="1adbf-539">GP 固有の名前: Install</span><span class="sxs-lookup"><span data-stu-id="1adbf-539">GP unique name: Install</span></span>
- <span data-ttu-id="1adbf-540">GP の名前: インストールを許可する</span><span class="sxs-lookup"><span data-stu-id="1adbf-540">GP name: Allow installation</span></span>
- <span data-ttu-id="1adbf-541">GP パス: 管理用テンプレート/Microsoft Edge Update/Microsoft Edge WebView</span><span class="sxs-lookup"><span data-stu-id="1adbf-541">GP path: Administrative Templates/Microsoft Edge Update/Microsoft Edge WebView</span></span>
- <span data-ttu-id="1adbf-542">GP ADMX ファイル名:  msedgeupdate.admx</span><span class="sxs-lookup"><span data-stu-id="1adbf-542">GP ADMX file name: msedgeupdate.admx</span></span>
##### <span data-ttu-id="1adbf-543">Windows レジストリの設定</span><span class="sxs-lookup"><span data-stu-id="1adbf-543">Windows Registry Settings</span></span>
- <span data-ttu-id="1adbf-544">パス: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span><span class="sxs-lookup"><span data-stu-id="1adbf-544">Path: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span></span>
- <span data-ttu-id="1adbf-545">キーの値: </span><span class="sxs-lookup"><span data-stu-id="1adbf-545">Value Name:</span></span> 
  - <span data-ttu-id="1adbf-546">Install{F3017226-FE2A-4295-8BDF-00C3A9A7E4C5}</span><span class="sxs-lookup"><span data-stu-id="1adbf-546">Install{F3017226-FE2A-4295-8BDF-00C3A9A7E4C5}</span></span>
- <span data-ttu-id="1adbf-547">値の種類: REG_DWORD</span><span class="sxs-lookup"><span data-stu-id="1adbf-547">Value Type: REG_DWORD</span></span>
##### <span data-ttu-id="1adbf-548">サンプル値:</span><span class="sxs-lookup"><span data-stu-id="1adbf-548">Example value:</span></span>
```
0x00000001
```
[<span data-ttu-id="1adbf-549">ページのトップへ</span><span class="sxs-lookup"><span data-stu-id="1adbf-549">Back to top</span></span>](#microsoft-edge---update-policies)


### <span data-ttu-id="1adbf-550">更新 (WebView)</span><span class="sxs-lookup"><span data-stu-id="1adbf-550">Update (WebView)</span></span>
#### <span data-ttu-id="1adbf-551">更新ポリシーのオーバーライド</span><span class="sxs-lookup"><span data-stu-id="1adbf-551">Update policy override</span></span>
><span data-ttu-id="1adbf-552">Microsoft Edge Update 1.3.127.1 以降</span><span class="sxs-lookup"><span data-stu-id="1adbf-552">Microsoft Edge Update 1.3.127.1 and later</span></span>

#### <span data-ttu-id="1adbf-553">説明</span><span class="sxs-lookup"><span data-stu-id="1adbf-553">Description</span></span>
<span data-ttu-id="1adbf-554">Microsoft Edge WebView の自動更新を有効にするかどうかを指定できます。</span><span class="sxs-lookup"><span data-stu-id="1adbf-554">Lets you specify whether or not automatic updates are enabled for Microsoft Edge WebView.</span></span> <span data-ttu-id="1adbf-555">Microsoft Edge WebView は、アプリケーションが Web コンテンツを表示するために使用するコンポーネントです。</span><span class="sxs-lookup"><span data-stu-id="1adbf-555">Microsoft Edge WebView is a component used by applications to display web content.</span></span>
<span data-ttu-id="1adbf-556">自動更新は、既定で有効になっています。</span><span class="sxs-lookup"><span data-stu-id="1adbf-556">Automatic updates are enabled by default.</span></span> <span data-ttu-id="1adbf-557">Microsoft Edge WebView の自動更新を無効にすると、このコンポーネントに依存するアプリケーションで互換性の問題が発生する可能性があります。</span><span class="sxs-lookup"><span data-stu-id="1adbf-557">Disabling automatic updates for Microsoft Edge WebView might cause compatibility issues with applications that depend on this component.</span></span>

  <span data-ttu-id="1adbf-558">このポリシーを有効にした場合、Microsoft Edge Update では、以下のオプションの構成方法に従って Microsoft Edge WebView の更新プログラムを処理します。</span><span class="sxs-lookup"><span data-stu-id="1adbf-558">If you enable this policy, Microsoft Edge Update handles Microsoft Edge WebView updates according to how you configure the following options:</span></span>
  - <span data-ttu-id="1adbf-559">[常に更新プログラムを許可する]: 更新プログラムは自動的にダウンロードされ、適用されるます</span><span class="sxs-lookup"><span data-stu-id="1adbf-559">Always allow updates: Updates are automatically downloaded and applied</span></span>
  - <span data-ttu-id="1adbf-560">[更新を無効にする]: 更新プログラムはダウンロードまたは適用されません</span><span class="sxs-lookup"><span data-stu-id="1adbf-560">Updates disabled: Updates are never downloaded or applied</span></span>

  <span data-ttu-id="1adbf-561">このポリシーを有効にしないと、更新プログラムが自動的にダウンロードされ、適用されます。</span><span class="sxs-lookup"><span data-stu-id="1adbf-561">If you don't enable this policy, updates are automatically downloaded and applied.</span></span>
#### <span data-ttu-id="1adbf-562">Windows の情報と設定</span><span class="sxs-lookup"><span data-stu-id="1adbf-562">Windows information and settings</span></span>
##### <span data-ttu-id="1adbf-563">グループ ポリシー (ADMX) 情報</span><span class="sxs-lookup"><span data-stu-id="1adbf-563">Group Policy (ADMX) info</span></span>
- <span data-ttu-id="1adbf-564">GP 固有の名前: Update</span><span class="sxs-lookup"><span data-stu-id="1adbf-564">GP unique name: Update</span></span>
- <span data-ttu-id="1adbf-565">GP の名前: 更新ポリシーのオーバーライド</span><span class="sxs-lookup"><span data-stu-id="1adbf-565">GP name: Update policy override</span></span>
- <span data-ttu-id="1adbf-566">GP パス: 管理用テンプレート/Microsoft Edge Update/Microsoft Edge WebView</span><span class="sxs-lookup"><span data-stu-id="1adbf-566">GP path: Administrative Templates/Microsoft Edge Update/Microsoft Edge WebView</span></span>
- <span data-ttu-id="1adbf-567">GP ADMX ファイル名:  msedgeupdate.admx</span><span class="sxs-lookup"><span data-stu-id="1adbf-567">GP ADMX file name: msedgeupdate.admx</span></span>
##### <span data-ttu-id="1adbf-568">Windows レジストリの設定</span><span class="sxs-lookup"><span data-stu-id="1adbf-568">Windows Registry Settings</span></span>
- <span data-ttu-id="1adbf-569">パス: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span><span class="sxs-lookup"><span data-stu-id="1adbf-569">Path: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EdgeUpdate</span></span>
- <span data-ttu-id="1adbf-570">キーの値: </span><span class="sxs-lookup"><span data-stu-id="1adbf-570">Value Name:</span></span> 
  - <span data-ttu-id="1adbf-571">Update{F3017226-FE2A-4295-8BDF-00C3A9A7E4C5}</span><span class="sxs-lookup"><span data-stu-id="1adbf-571">Update{F3017226-FE2A-4295-8BDF-00C3A9A7E4C5}</span></span>
- <span data-ttu-id="1adbf-572">値の種類: REG_DWORD</span><span class="sxs-lookup"><span data-stu-id="1adbf-572">Value Type: REG_DWORD</span></span>
##### <span data-ttu-id="1adbf-573">サンプル値:</span><span class="sxs-lookup"><span data-stu-id="1adbf-573">Example value:</span></span>
```
0x00000001
```
[<span data-ttu-id="1adbf-574">ページのトップへ</span><span class="sxs-lookup"><span data-stu-id="1adbf-574">Back to top</span></span>](#microsoft-edge---update-policies)


## <span data-ttu-id="1adbf-575">関連項目</span><span class="sxs-lookup"><span data-stu-id="1adbf-575">See also</span></span>
  - [<span data-ttu-id="1adbf-576">Microsoft Edge の構成</span><span class="sxs-lookup"><span data-stu-id="1adbf-576">Configuring Microsoft Edge</span></span>](configure-microsoft-edge.md)
  - [<span data-ttu-id="1adbf-577">Microsoft Edge Enterprise ランディング ページ</span><span class="sxs-lookup"><span data-stu-id="1adbf-577">Microsoft Edge Enterprise landing page</span></span>](https://aka.ms/EdgeEnterprise)