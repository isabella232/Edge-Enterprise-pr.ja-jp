...
|||
|-|-|
|[Authentification HTTP](#authentification-http)|[キャスト](#cast)|
|[Démarrage, page d’accueil et page Nouvel onglet](#démarrage-page-d’accueil-et-page-nouvel-onglet)|[拡張機能](#extensions)|
...
|[Serveur proxy](#serveur-proxy)|[補足](#additional)|
...
|[Defaul/Securecontentsetting](#defaultinsecurecontentsetting)|Contrôler l’utilisation des exceptions de contenu non sécurisé|
...
通常、これはフィッシング詐欺への防御として無効になっています。 If you don't configure this policy, it's disabled and third-party images can't show an authentication prompt.
...
```
 ...
 Cette stratégie ne détermine pas la page qui s’ouvre au démarrage; cela est contrôlé par la stratégie [RestoreOnStartup](#restoreonstartup). Elle n’affecte pas non plus la page d’accueil si celle-ci est définie de manière à s'ouvrir dans le nouvel onglet.licy. また、新規タブ ページを開くように設定されている場合には、ホーム ページには影響しません。
...
If you enable this policy, Microsoft Edge won't use any version of SSL/TLS lower than the specified version. 認識されない値は、無視されます。
